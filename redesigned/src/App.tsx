...
export default function App() {
  ...
  const renderRedesign = () => (
    <div className="max-w-[1200px] mx-auto p-4 font-sans relative">
      <button
        onClick={() => navigate('home')}
        className="rd-nav-btn-back absolute top-8 left-4"
      >
      ...
      <div className="rd-category-container">
        ...
        <div className="rd-category-box">
          <h3 className="rd-category-title">Jobs & Gigs</h3>
          <div className="rd-category-divider"></div>
          <div className="rd-category-grid">
            <button onClick={() => navigate('wrong')} className="rd-active-btn">job offered</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">gig offered</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">resume / job wanted</button>
          </div>
        </div>
        ...
        <div className="rd-category-box">
          ...
          <div className="rd-category-grid">
            ...
            <button onClick={() => navigate('wrong')} className="rd-active-btn">housing wanted</button>
          </div>
        </div>

        {/* For Sale & Wanted */}
        <div className="rd-category-box">
          <h3 className="rd-category-title">For Sale & Wanted</h3>
          <div className="rd-category-divider"></div>
          <div className="rd-category-grid grid-cols-2">
            <button onClick={() => navigate('wrong')} className="rd-active-btn">for sale by owner</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">for sale by dealer</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">wanted by owner</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">wanted by dealer</button>
          </div>
        </div>

        {/* Services & Community */}
        <div className="rd-category-box">
          <h3 className="rd-category-title">Services & Community</h3>
          <div className="rd-category-divider"></div>
          <div className="rd-category-grid">
            <button onClick={() => navigate('wrong')} className="rd-active-btn">service offered</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">community</button>
            <button onClick={() => navigate('wrong')} className="rd-active-btn">event / class</button>
          </div>
        </div>
      </div>
